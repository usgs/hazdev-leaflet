...
*/
var GrayscaleLayer = function (options) {
  var layer,
      layerOptions,
      provider;
...
GrayscaleLayer.ESRI = _ESRI;
GrayscaleLayer.CARTODB = _CARTODB;

L.GrayscaleLayer = GrayscaleLayer;


module.exports = GrayscaleLayer;
