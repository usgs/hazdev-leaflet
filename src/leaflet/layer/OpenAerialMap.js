...
var _URL = 'http://otile{s}.mqcdn.com/tiles/1.0.0/sat/{z}/{x}/{y}.jpg';


var OpenAerialMap = L.TileLayer.extend({
...
L.openAerialMap = function (options) {
  return new OpenAerialMap(options);
};
